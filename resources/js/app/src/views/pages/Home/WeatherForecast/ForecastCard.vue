<template>
    <div
        class="flex flex-col items-center justify-center bg-gradient-to-br p-10 text-gray-700"
    >
        <Spinner class="w-full max-w-screen-sm" v-if="isLoading" />
        <div v-else class="w-full max-w-screen-sm rounded-xl px-10">
            ...
            <button
                @click="saveUserLocation"
                type="submit"
                class="mt-6 w-full rounded-lg bg-sky-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-sky-800 focus:outline-none focus:ring-4 focus:ring-blue-300 sm:w-auto dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
                Save
            </button>
        </div>
